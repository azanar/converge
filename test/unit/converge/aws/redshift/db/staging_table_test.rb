...
require 'converge/aws/redshift/db/staging_table'

class Converge::AWS::Redshift::DB::StagingTableTest < Test::Unit::TestCase
...
class Converge::AWS::Redshift::DB::StagingTable::LoaderTest < Test::Unit::TestCase
  setup do
    ...
    @staging_table = Converge::AWS::Redshift::DB::StagingTable.new(@mock_model)
  end
  ...
  test 'load no remove quote table' do
    ...
    _object_collection.expects(:url).returns("s3://#{@test_host}/#{@test_table}")
